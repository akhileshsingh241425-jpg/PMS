    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-900">PMS v2</h1>
          <p className="text-sm text-gray-500">INFOCUS-IT Project Management</p>
        </div>

        <form onSubmit={isBootstrap ? handleBootstrap : handleLogin} className="bg-white rounded-2xl shadow-xl p-6 space-y-4">
